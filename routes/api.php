...
use App\Http\Controllers\RequestImageController; // Import the RequestImageController after patch
...
Route::middleware('auth:sanctum')->delete('/requests/{request_id}/images/{image_id}', [RequestImageController::class, 'deleteRequestImage']);
