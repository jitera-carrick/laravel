...
// New route for GET request to verify user email
Route::get('/users/verify/{token}', [VerifyEmailController::class, 'verify'])
    ->name('verification.verify')->middleware('throttle:api');
