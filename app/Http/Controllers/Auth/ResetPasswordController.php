...
class ResetPasswordController extends Controller
{
    ...
    public function validateResetToken(Request $request): JsonResponse
    {
        try {
            ...
            return Response::json(['message' => 'Password reset token is valid.'], 200);
        } catch (\Exception $e) {
            return Response::json(['message' => 'An error occurred while validating the password reset token.'], 500);
        }
    }
